...
<body class="transition-colors duration-500 bg-white dark:bg-black">
    ...
    <div>
        ...
        <button 
            id="theme-toggle" 
            class="group relative inline-flex h-12 w-24 items-center rounded-full border-2 border-black bg-white p-1 transition-colors duration-500 dark:border-white dark:bg-black"
        >
            <span 
                id="toggle-circle"
                class="flex h-9 w-9 transform items-center justify-center rounded-full bg-black text-white transition-transform duration-500 ease-in-out dark:translate-x-12 dark:bg-white dark:text-black"
            >
